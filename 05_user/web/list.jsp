        ...
        <script>
            ...
            window.onload = function () {
                ...
                document.getElementById("firstCb").onclick = function () {
                    ...
                    //3.遍历
                    for (var i = 0; i < cbs.length; i++) {
                        //4.设置这些cbs[i]大的checked状态 = firstCb.checked
        ...
        <div class="container">
            ...
            <div style="float: left">
                ...
                <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet"
                    ...
                    <div class="form-group">
                        <label for="exampleInputName2">姓名</label><%--因为取出来的name是数组,需要加上[0]来取得单个元素--%>
            ...
            <form id="form" action="${pageContext.request.contextPath}/delSelectedServlet" method="post">
                <table border="1" class="table table-bordered table-hover">
                    ...
                    <%-- 在userPageBean中有List<User> 所以遍历userPageBean.list可以直接用user  --%>
